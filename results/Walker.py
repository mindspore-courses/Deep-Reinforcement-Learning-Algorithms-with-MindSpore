...
config.file_to_save_data_results = "results/data_and_graphs/Walker_Results_Data.pkl"
config.file_to_save_results_graph = "results/data_and_graphs/Walker_Results_Graph.png"
