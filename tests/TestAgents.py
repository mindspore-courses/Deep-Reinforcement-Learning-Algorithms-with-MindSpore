...
config.hyperparameters = {
    ...
    "Policy_Gradient_Agents": {
        ...
        # "epsilon_decay_rate_denominator": 0.99,
...
def test_agent_solve_bit_flipping_game():
    """bit flopping"""
    AGENTS = [DDQN, DQN_With_Fixed_Q_Targets, DDQN_With_Prioritised_Experience_Replay, DQN, DQN_HER]
...
def test_agents_can_play_games_of_different_dimensions():
    ...
    AGENTS = [PPO, DDQN, DQN_With_Fixed_Q_Targets, DDQN_With_Prioritised_Experience_Replay, DQN]
    trainer = Trainer(config, AGENTS)
